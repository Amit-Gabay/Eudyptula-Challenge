# :memo: **My Solutions to the Eudyptula Challenge**

The **Eudyptula Challenge** is a series of 20 progressively complex tasks designed to teach the **fundamentals of Linux kernel development**.
Starting with simple exercises like writing a "Hello World" kernel module, the challenge gradually escalates to more advanced topics, ultimately involving submitting patches to the main **Linux kernel source tree**.

This repository contains my solutions to these tasks, showcasing my journey through the challenge and my growth as a **Linux kernel contributor**. :muscle: :penguin:
